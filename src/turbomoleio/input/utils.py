...
def get_define_template(name):
    ...
    filepath = os.path.join(
        os.path.abspath(os.path.dirname(__file__)), "templates", name
    )
...
schema_define_params = {
    "title": {"type": "string", "nullable": True, "default": ""},
    "metric": {"type": "integer", "nullable": True, "default": None},
    "copymo": {"type": "string", "nullable": True, "default": None},
    "sym": {"type": "string", "nullable": True, "default": None},
    "sym_eps": {"type": "float", "nullable": True, "default": None},
    "desy": {"type": "boolean", "default": True},
    "desy_eps": {
        "type": "float",
        "nullable": True,
        "dependencies": {"desy": True},
        "default": None,
    },
    "ired": {"type": "boolean", "default": True},
    "usemo": {"type": "string", "nullable": True, "default": None},
    "ex_method": {
        "type": "string",
        "nullable": True,
        "allowed": ex_method,
        "dependencies": {"ex_multi": ex_multi},
        "default": None,
    },
    "ex_multi": {
        "type": "string",
        "nullable": True,
        "allowed": ex_multi,
        "dependencies": {"ex_method": ex_method},
        "default": None,
    },
    "ex_all_states": {
        "type": "integer",
    ...
    "ex_exopt": {"type": "integer", "nullable": True, "default": None, "min": 0},
    "method": {
        "type": "string",
        "default": "dft",
        "allowed": ["dft", "hf", "mp2", "adc(2)", "ccsd(t)", "ccsdt"],
    },
    "mp2energy": {"type": "integer", "nullable": True, "default": None},
    "basis": {"type": "string", "default": None, "nullable": True},
    "basis_atom": {
        "type": "dict",
        "nullable": True,
        "keysrules": {"type": "string"},
    ...
    "rijk": {
        ...
        "default": False,
        "oneof": [
            {"allowed": [True], "dependencies": {"ri": False}},
            {"allowed": [False]},
        ],
    },
    "ri": {
        ...
        "default": False,
        "oneof": [
            {"allowed": [True], "dependencies": {"rijk": False}},
            {"allowed": [False]},
        ],
    },
    "marij": {
        ...
        "default": False,
        "oneof": [
            {"allowed": [True], "dependencies": {"rijk": False, "ri": True}},
            {"allowed": [False]},
        ],
    },
    "functional": {"type": "string", "nullable": True, "default": None},
    "gridsize": {"type": "string", "nullable": True, "default": None},
    "maxcor": {
        "type": "float",
        "nullable": True,
        "default": None,
    ...
    "use_f12": {
        ...
        "default": False,
        "oneof": [
            {"allowed": [True], "dependencies": {"method": mp2_calc}},
            {"allowed": [False]},
        ],
    },
    "use_f12*": {
        ...
        "default": False,
        "oneof": [
            {"allowed": [True], "dependencies": {"method": mp2_calc, "use_f12": True}},
            {"allowed": [False]},
        ],
    },
    "maxiter": {
    ...
    "scfiterlimit": {"type": "integer", "default": 200},
    "scfconv": {"type": "integer", "nullable": True, "min": 4, "max": 9},
    "coord_file": {"type": "string", "nullable": True, "default": None},
    "disp": {
        "type": "string",
        "nullable": True,
...
#: An instance of cerberus.Validator that can be used to validate
# the input for DefineRunner.
define_parameters_validator = cerberus.Validator(
    schema=schema_define_params, ignore_none_values=True
)
...
def validate_parameters(parameters):
    ...
    This function uses the cerberus tool and the schema_define_params dictionary
