...
TM_VERSIONS = ["TM_v7.3", "TM_v7.3.1", "TM_v7.4.1", "TM_v7.5.1", "TM_v7.6", "TM_v7.7.1"]
PARSER_METHODS = [
    "all_done",
    "header",
    "centers",
...
def get_test_data_dir(module=None):
    ...
    if len(found_paths) == 0:
        raise RuntimeError("test_data directory not found.")
    if len(found_paths) > 1:
        raise RuntimeError("Found multiple turbomoleio directories.")
