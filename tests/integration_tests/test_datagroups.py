...
from turbomoleio.core.control import Control, Shells, cdg, cpc, mdgo, sdg, sdgo
...
from turbomoleio.testing import ItestConfig, temp_dir
...
class TestControl:
    ...
    def test_cpc(self, molecule_filepath, delete_tmp_dir):
        with temp_dir(delete_tmp_dir):
            ...
            if ret_code:
                raise RuntimeError(
                    "original cpc failed with return code {}".format(ret_code)
                )
